...
def xgboost_main(X_train, y_train, X_test, y_test, X_val, y_val, feature_names, n_class, max_epochs, batch_size):
    test_preds, train_preds, proba_test, proba_train = xgboost_t.xgboost_train(X_train, y_train, X_test, y_test,
    ...
    y_pred_test1, y_pred_train1, proba_test1, proba_train1, history_loss1 = xgboost_t.xgboost_XGBClassifier(X_train, y_train, X_test, y_test,
...
def catboost_main(X_train, y_train, X_test, y_test, X_val, y_val, feature_names, n_class, max_epochs, batch_size):
    ...
    y_pred_test1, y_pred_train1, proba_test1, proba_train1, history_loss1 = catboost_.catboost_CatBoostClassifier(X_train, y_train, X_test,
                                                                                           y_test, X_val, y_val, feature_names,
...
def lightgbm_main(X_train, y_train, X_test, y_test, X_val, y_val, feature_names, n_class, max_epochs, batch_size):
    y_pred_test, y_pred_train, proba_test, proba_train = lightgbm_.lightgbm_train(X_train, y_train, X_test, y_test, X_val, y_val,
...
def tabnet_main(X_train, y_train, X_test, y_test, X_val, y_val, max_epochs, batch_size):
    y_pred_test, y_pred_train, proba_test, proba_train, history_loss = tabnet_.tabnet_TabNetMultiTaskClassifier(X_train, y_train, X_test,
                                                                                            y_test, X_val, y_val,
                                                                                            max_epochs, batch_size)
